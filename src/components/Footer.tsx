      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-xl font-semibold">AgencyHub</span>
            </div>
            <p className="text-primary-foreground/70 text-sm max-w-sm">
              The premier directory for finding top-rated agencies. Connect with the perfect partner for your next project.
            </p>
          </div>
        ...
        <div className="border-t border-primary-foreground/10 mt-10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-primary-foreground/50">
            © 2024 AgencyHub. All rights reserved.
          </p>
